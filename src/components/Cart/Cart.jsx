...
const Cart = () => {
    ...
    if(cart.length > 0){
        return(
            <section className="h-full text-center mx-96">
                ...
                {cart.map((prod) => (
                    <div key={prod.id} className="text-center mt-11 flex justify-evenly bg-[#02236d] rounded-md w-full p-4 shadow-inner shadow-black/50">
                        <h3 className="text-white w-50 text-lg">{prod.title}</h3>
